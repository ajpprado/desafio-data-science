...
O resultado de ambos os testes nos revelou um p-value considerávelmente baixo, de 2.2 * 10^(-16). A partir desse valor podemos com confiança rejeitar a hipótese nula em favor da hipótese alternativa, isto é, o resultado da campanha anterior tem relevância ao predizermos o resultado da campanha atual.
